...
class SignUpSearch extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if(this.props.sSignUpStore.isSignUpFailed) {
            this.props.enqueueSnackbar('회원 가입에 실패하였습니다.', {
                variant: 'error'
            });

            this.props.sSignUpStore.clearState();
        }

        if(this.props.sSignUpStore.isNotAvailableEmail) {
...
export default withSnackbar(withRouter(withStyles(style) (SignUpSearch)));