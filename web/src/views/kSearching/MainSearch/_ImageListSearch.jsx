...
@observer
class _ImageListSearch extends Component{
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const { searchResult, searchRequestState, addSearchResultRequestState } = this.props.sTextSearchStore;
...
export default withStyles(style)(_ImageListSearch);
