...
@inject('mSignUpStore')
@observer
class QuestionsMatch extends Component {
    constructor(props) {
        super(props);
        this.state = {
            questionsList: [
    ...
    handleKeyUpId = (event) => {
        if( this.props.mSignUpStore.isCheckQuestion && this.props.mSignUpStore.isCheckAnswer && event.keyCode===13){
    ...
    export default withSnackbar(withRouter(withStyles(style) (QuestionsMatch)));
