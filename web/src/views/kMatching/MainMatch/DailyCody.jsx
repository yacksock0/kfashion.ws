...
import ImageUpload  from './ImageUploadMatch';
import ImageList from './ImageListMatch';
...
class DailyCody extends Component{
...
export default withStyles(style)(DailyCody);
