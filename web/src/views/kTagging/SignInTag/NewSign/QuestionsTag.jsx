...
@inject('tSignUpStore')
@observer
class QuestionsTag extends Component {
    constructor(props) {
    super(props);
    this.state = {
        questionsList : [
    ...
    // handleClickOK = () => {
    //     if(this.state.url === "singUp") this.props.tSignUpStore.doSignUp(this.props.history);
    //     else if(this.state.url === "findId") this.props.tSignUpStore.doFindUser(this.props.history, "ID");
    //     else if(this.state.url === "findPw") this.props.tSignUpStore.doFindUser(this.props.history, "PW");
    //
    // }
    handleKeyUpId = (event) => {
        if (this.props.tSignUpStore.isCheckQuestion && this.props.tSignUpStore.isCheckAnswer && event.keyCode === 13) {
...
export default withSnackbar(withRouter(withStyles(style) (QuestionsTag)));
