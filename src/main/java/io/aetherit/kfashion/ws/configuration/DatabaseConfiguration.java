...
import io.aetherit.kfashion.ws.configuration.support.DatabaseProperties;
import io.aetherit.kfashion.ws.util.SystemEnvUtil;
...
@MapperScan(value = "io.aetherit.kfashion.ws.repository.mapper")
