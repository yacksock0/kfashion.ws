...
//        map.put("userId", simpleUser.getUserId()+"");
//        map.put("email", simpleUser.getEmail());
//        map.put("userName", simpleUser.getUserName());
//        map.put("typeCode", simpleUser.getTypeCode()+"");
//
...
//     * @return
//     */
///*    public String getJwtToken(OTLSimpleUser simpleUser){
//
//    	SignatureAlgorithm signatureAlgorithm = SignatureAlgorithm.HS256;
//        Date expireTime = new Date();
