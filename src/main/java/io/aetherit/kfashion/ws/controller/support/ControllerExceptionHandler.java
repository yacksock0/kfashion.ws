package io.aetherit.kfashion.ws.controller.support;

import io.aetherit.kfashion.ws.exception.KfashionException;
import io.aetherit.kfashion.ws.exception.ErrorCode;
import io.aetherit.kfashion.ws.exception.ErrorResponse;
...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(KfashionException.class)
    public ResponseEntity<ErrorResponse> handleBaseException(HttpServletRequest httpRequest, KfashionException ex) {
    ...
    private ErrorResponse getErrorResponse(Exception ex, HttpServletRequest httpServletRequest, HttpStatus status) {
        ...
        if(ex instanceof KfashionException) {
            errorCode = ((KfashionException) ex).getErrorCode();
        }
